                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="liquid-glass rounded-[32px] overflow-hidden flex flex-col h-full min-w-0 shadow-sm border border-white/60">
                        ...
                        <div className="p-5 flex-1 flex flex-col space-y-5 min-w-0">
                            ...
                            {/* KHỐI NÀY ĐÃ ĐƯỢC CHUYỂN THÀNH MÀU SÁNG TRẮNG, BÓNG BẨY */}
                        ...
                        <div className="flex flex-col gap-4 md:gap-5 min-w-0">
                            {(enrichedDaily || []).map((row, index) => {
                                ...
                                return (
                                    <div 
                                        key={row.id || index} 
                                        className={`bg-white/60 hover:bg-white border shadow-sm hover:shadow-md rounded-[24px] p-4 md:p-5 transition-all flex flex-col xl:flex-row xl:items-center justify-between gap-4 xl:gap-6 w-full min-w-0 ${isMVP ? 'border-[#FF9500]/40 bg-[#FF9500]/5' : 'border-white/80'}`}
                                    >
                                        
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 xl:w-[40%] min-w-0">
                                            ...
                                            <div className="flex items-center gap-3 md:gap-4 min-w-0 flex-1">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex items-center gap-1.5 mb-0.5 min-w-0">
                                                        ...
                                                        <h3 className="font-bold text-[#1D1D1F] text-[14px] md:text-[15px] leading-snug truncate group-hover:text-[#1A5B82] transition-colors">
                                                            {row.ten_san_pham || '---'}
                                                        </h3>
                                                    ...
                                                    <div className="text-[11px] md:text-[12px] text-[#5c5c5c] font-medium tabular-nums truncate">
                                                        {formatDateDisplay(row.ngay_ban)}
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <div className="flex flex-col sm:items-end pl-[52px] md:pl-16 sm:pl-0 shrink-0">
                                                <span className="text-[8px] font-bold text-[#8E8E93] uppercase tracking-wider mb-0.5">Cập nhật</span>
                                                <div className="text-[10px] font-semibold text-[#1A5B82] bg-blue-50/60 px-2 py-0.5 rounded-[6px] border border-blue-100/50 shadow-sm whitespace-nowrap">
                                                    {row.updatedAt ? formatDateTime(row.updatedAt) : formatDateTime(row.ngay_ban)}
                                                </div>
                                            </div>
                                        </div>

                                        <div className="flex justify-between sm:justify-start xl:justify-center gap-2 md:gap-3 shrink-0 xl:w-[25%] pl-[52px] md:pl-16 sm:pl-0 w-full xl:w-auto">
                                            <div className="flex-1 sm:flex-none w-[60px] md:w-[65px] shrink-0 bg-white/70 border border-gray-200/60 rounded-[14px] py-2 text-center shadow-sm">
                                            ...
                                            <div className={`flex-1 sm:flex-none w-[60px] md:w-[65px] shrink-0 rounded-[14px] py-2 text-center shadow-sm border ${isBanGreater ? 'bg-[#1DB2A0]/10 border-[#1DB2A0]/20' : 'bg-white/70 border-gray-200/60'}`}>
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between xl:justify-end gap-3 sm:gap-4 shrink-0 xl:w-[35%] pl-[52px] md:pl-16 sm:pl-0 border-t sm:border-none border-gray-200/60 pt-3 sm:pt-0 mt-1 sm:mt-0 w-full xl:w-auto">
                                            
                                            <div className="flex flex-row sm:flex-col justify-between sm:justify-center gap-1 sm:gap-0 sm:text-right shrink-0 sm:min-w-[110px]">
