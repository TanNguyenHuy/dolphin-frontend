...
export default function DashboardView({
    ...
    return (
        <div className="space-y-6 md:space-y-8 animate-fade-in-up pb-10">
            ...
            <div id="section-loi-nhuan" className="max-w-6xl mx-auto w-full scroll-mt-[130px]">
                <DashboardChart 
            ...
            <div id="section-kho-thue" className="max-w-4xl mx-auto w-full pt-4 scroll-mt-[130px]">
                <DashboardStats 
            ...
            <div id="section-danh-sach" className="liquid-glass rounded-[32px] p-3 sm:p-6 md:p-8 border border-white/60 shadow-sm pt-4 scroll-mt-[130px]">
