...
            {/* HEADER - ĐÃ ĐƯỢC FIX LẠI ĐỂ HIỂN THỊ NÚT TRÊN ĐIỆN THOẠI MỘT CÁCH TINH TẾ */}
...
                        <>
                            {isAdmin && (
                                /* ĐÃ XÓA hidden md:flex. Bây giờ luôn hiển thị */
                                <button onClick={() => setView('USERS')} title="Quản lý Người dùng" className="w-9 h-9 md:w-11 md:h-11 flex items-center justify-center bg-white/30 border border-white/40 text-[#1DB2A0] rounded-full hover:bg-white/60 transition-all shadow-sm active:scale-95"><Users size={16} className="md:w-[18px] md:h-[18px]"/></button>
                            )}
                            {canEdit && (
                                /* ĐÃ BIẾN THÀNH NÚT ICON TRÒN TRÊN ĐIỆN THOẠI BẰNG CLASS MỚI */
